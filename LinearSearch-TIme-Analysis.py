import time
import random
import pandas as pd  # Consider removing if not used for data analysis
...
def main():
    ...
    for _ in range(num_experiments):
        ...
        arr = [random.randint(1, 100) for _ in range(array_size)]  # Create random array
    ...
    plt.plot(storage2, storage, marker='o', linestyle='-')  # Connect data points
